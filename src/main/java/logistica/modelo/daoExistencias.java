...
public class daoExistencias {
    ...
    private static final String SQL_UPDATE = "UPDATE tbl_existencias SET bodcodigo=? prodcodigo=?, exisaldo=? WHERE bodcodigo = ?";
    private static final String SQL_DELETE = "DELETE FROM tbl_existencias WHERE bodcodigo=?";
    private static final String SQL_QUERY  = "SELECT bodcodigo, prodcodigo, exisaldo FROM tbl_existencias WHERE bodcodigo = ?";
