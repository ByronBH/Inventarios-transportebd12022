...
public class daoProductos {
    ...
    private static final String SQL_UPDATE = "UPDATE tbl_productos SET prodcodigo=? prodnombre=?, prodexistencia=?, prodestatus=?,marcodigo=?, lincodigo=?  WHERE bodcodigo = ?";
    private static final String SQL_DELETE = "DELETE FROM tbl_productos WHERE prodcodigo=?";
    private static final String SQL_QUERY  = "SELECT tbl_productos(prodcodigo, prodnombre, prodexistencia, prodestatus, marcodigo, lincodigo, marnombre, linnombre FROM tbl_productos WHERE prodcodigo = ?";
