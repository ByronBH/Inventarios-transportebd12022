...
public class daoTransporte {
    ...
    private static final String SQL_UPDATE = "UPDATE tbl_transporte SET tranmatricula=? tranmodelo=?, tranmarca=?, trantipo=? WHERE tranmatricula = ?";
    ...
    public int update(clsTransporte perfil) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        try {
            ...
            stmt = conn.prepareStatement(SQL_UPDATE);
             ...
             stmt.setString(1, perfil.getTranmodelo());
            stmt.setString(2, perfil.getTranmarca());
            stmt.setString(3, perfil.getTrantipo());
